...
// classification and cross-band candidate pairing. Pure functions — no engine, no server.
//
// Run: pnpm test   (tsx --test)

import { strict as assert } from "node:assert";
import { test } from "node:test";
import { pairPersons, personBand, type PersonInfo } from "../src/identities.ts";
